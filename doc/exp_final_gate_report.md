...
- `E1_hotpot_relrag_b2000_run2`
  - `NO_PROXY=127.0.0.1,localhost no_proxy=127.0.0.1,localhost HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 LLM_PROFILE=llm_a python scripts/hotpotqa/baselines/run_relrag.py --dataset data/hotpotqa/dataset_distractor_200.json --workdir result_relrag/final_gate/20251222_113702/E1_hotpot_relrag_b2000_run2 --context-budget 2000 --limit 20 --lm-endpoint http://127.0.0.1:1234/v1 --lm-model qwen/qwen3-30b-a3b --embed-model /home/wjk/models/hf-cache/models--sentence-transformers--all-MiniLM-L6-v2/snapshots/c9745ed1d9f207416be6d2e6f8de32d1f16199bf --embed-device cpu --max-new-tokens 128`
...
- `E7_hotpot_relrag_llm_b_run2` (limit=5)
  - `NO_PROXY=127.0.0.1,localhost no_proxy=127.0.0.1,localhost HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 LLM_PROFILE=llm_b python scripts/hotpotqa/baselines/run_relrag.py --dataset data/hotpotqa/dataset_distractor_200.json --workdir result_relrag/final_gate/20251222_113702/E7_hotpot_relrag_llm_b_run2 --context-budget 2000 --limit 5 --lm-endpoint http://127.0.0.1:1234/v1 --lm-model qwen/qwen3-30b-a3b --embed-model /home/wjk/models/hf-cache/models--sentence-transformers--all-MiniLM-L6-v2/snapshots/c9745ed1d9f207416be6d2e6f8de32d1f16199bf --embed-device cpu --max-new-tokens 128`
...
- `mirage_b2000_run2`
  - `NO_PROXY=127.0.0.1,localhost no_proxy=127.0.0.1,localhost HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 LLM_PROFILE=llm_a python scripts/mirage/run_vanilla_rag.py --dataset-path data/mirage_sample_200/dataset.json --workdir result_relrag/final_gate/20251222_113702/mirage_b2000_run2 --context-budget 2000 --limit 20 --retriever bm25 --topk 10 --lmstudio-endpoint http://127.0.0.1:1234/v1 --lmstudio-model qwen/qwen3-30b-a3b`
...
E7 profile switch verified via `config.resolved.json`: llm_profile=llm_a vs llm_b.
